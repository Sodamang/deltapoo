...
function scr_anyface(_speakerC, _msgno, _emotion) {
    ...
    if (_speaker == "berdly" || _speaker == "ber")
        msgsetloc(argument1, "\\TX \\F0 \\E" + string(_emotion) + " \\FB \\TB %", "scr_anyface_slash_scr_anyface_gml_23_0")
    if (_speaker == "alphys" || _speaker == "alp")
        msgsetloc(argument1, "\\TX \\F0 \\E" + string(_emotion) + " \\Fa \\Ta %", "scr_anyface_slash_scr_anyface_gml_24_0")
    ...
    if (_speaker == "queen" || _speaker == "que")
        msgsetloc(argument1, "\\TX \\F0 \\E" + string(_emotion) + " \\FQ \\TQ %", "scr_anyface_slash_scr_anyface_gml_27_0")
    if (_speaker == "queen2" || _speaker == "que2")
        msgsetloc(argument1, "\\TX \\F0 \\E" + string(_emotion) + " \\F0 \\Tq %", "scr_anyface_slash_scr_anyface_gml_28_0_b")
    if (_speaker == "sans" || _speaker == "san")
        msgsetloc(argument1, "\\TX \\F0 \\E" + string(_emotion) + " \\Fs \\Ts %", "scr_anyface_slash_scr_anyface_gml_28_0")
    if (_speaker == "undyne" || _speaker == "und")
        msgsetloc(argument1, "\\TX \\F0 \\E" + string(_emotion) + " \\FU \\TU %", "scr_anyface_slash_scr_anyface_gml_29_0")
    if (_speaker == "burgerpants")
        msgsetloc(argument1, "\\TX \\F0 \\E" + string(_emotion) + " \\Fb \\T0 %", "scr_anyface_slash_scr_anyface_gml_30_0")
    if (_speaker == "sneo")
        msgset(argument1, "\\TX \\F0 \\E" + string(_emotion) + " \\Tp %")
    return;
}
