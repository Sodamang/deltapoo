...
c_wait(120)
    ...
    c_jump_sprite(480, 98, 8, 8, spr_kris_jump_0, spr_kris_dw_landed)
    c_delayfacing(16, "r")
    c_sel(su)
    c_delayfacing(16, "r")
    c_jump_sprite(480, 98, 8, 8, spr_susie_jump_0, spr_susie_dw_landed)
	c_sel(kr)
    ...
    c_talk_wait()
	c_var_instance(chara, "ononion", true)
	c_var_instance(onion, "die", 1)
	c_actortokris()
